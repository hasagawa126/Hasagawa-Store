...
async def font_yins(ayiin):
    ...
    await ayiin.reply("generated by: 𝗜𝗫𝗔𝗟𝗟-userbot")
...
async def _(ayiin):
    ...
    await ayiin.reply("generated by: 𝗛𝗮𝘀𝗮𝗴𝗮𝘄𝗮-𝗦𝘁𝗼𝗿𝗲")
    if not yins:
...
async def fonts(yins):
    ayiin = await edit_or_reply(yins,
                                ...
                                "**• outline      > 𝕙𝕒𝕤𝕒𝕘𝕒𝕨𝕒**\n"
                                "**• script       > 𝒽𝒶𝓈𝒶ℊ𝒶𝓌𝒶**\n"
                                "**• blackbubbles > 🅗︎🅐︎🅢︎🅐︎🅖︎🅐︎🅦︎🅐︎**\n"
                                "**• bubbles      > Ⓗ︎Ⓐ︎Ⓢ︎Ⓐ︎Ⓖ︎Ⓐ︎Ⓦ︎Ⓐ︎**\n"
                                "**• bold         > 𝗛𝗮𝘀𝗮𝗴𝗮𝘄𝗮**\n"
                                "**• bolditalic   > 𝙝𝙖𝙨𝙖𝙜𝙖𝙬𝙖**\n\n"
                                "**𝗛𝗮𝘀𝗮𝗴𝗮𝘄𝗮-𝗦𝘁𝗼𝗿𝗲!**")
